...
import PlanesCard from "@/Components/PlanesCard.vue";
</script>

<template>
  <PlantillaIndex>
    <div class="bg-purple-200 py-10 rounded-b-lg">
      <h1 class="text-center text-5xl font-bold text-gray-800">Planes</h1>
    </div>
